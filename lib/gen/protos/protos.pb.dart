...
class AndroidConfiguration extends $pb.GeneratedMessage {
  ...
  factory AndroidConfiguration.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AndroidConfiguration.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  AndroidConfiguration clone() =>
      AndroidConfiguration()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
  ...
  AndroidConfiguration copyWith(void Function(AndroidConfiguration) updates) =>
      super.copyWith((message) => updates(message as AndroidConfiguration))
          as AndroidConfiguration; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AndroidConfiguration create() => AndroidConfiguration._();
  AndroidConfiguration createEmptyInstance() => create();
  static $pb.PbList<AndroidConfiguration> createRepeated() =>
      $pb.PbList<AndroidConfiguration>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set aspectTolerance($core.double v) {
    $_setDouble(0, v);
  }
...
class Configuration extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set android(AndroidConfiguration v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(5)
  set autoEnableFlash($core.bool v) {
    $_setBool(4, v);
  }
...
class ScanResult extends $pb.GeneratedMessage {
  ...
  ScanResult copyWith(void Function(ScanResult) updates) =>
      super.copyWith((message) => updates(message as ScanResult))
          as ScanResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
