...
struct AndroidConfiguration: Sendable {
...
extension BarcodeFormat: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0unknown\0\u{1}aztec\0\u{1}code39\0\u{1}code93\0\u{1}ean8\0\u{1}ean13\0\u{1}code128\0\u{1}dataMatrix\0\u{1}qr\0\u{1}interleaved2of5\0\u{1}upce\0\u{1}pdf417\0")
}

extension ResultType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0Barcode\0\u{1}Cancelled\0\u{1}Error\0")
}
...
extension AndroidConfiguration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}aspectTolerance\0\u{1}useAutoFocus\0\u{1}appBarTitle\0")
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.aspectTolerance.bitPattern != 0 {
    ...
    if !self.appBarTitle.isEmpty {
      try visitor.visitSingularStringField(value: self.appBarTitle, fieldNumber: 3)
    }
  ...
  static func ==(lhs: AndroidConfiguration, rhs: AndroidConfiguration) -> Bool {
    ...
    if lhs.appBarTitle != rhs.appBarTitle {return false}
...
extension Configuration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}strings\0\u{1}restrictFormat\0\u{1}useCamera\0\u{1}android\0\u{1}autoEnableFlash\0")
...
extension ScanResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{1}rawContent\0\u{1}format\0\u{1}formatNote\0")
